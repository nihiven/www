...
const server = http.createServer(async (req, res) => {
  ...
  try {
    ...
    // Remove leading slash and resolve path from 'md' directory
    filePath = path.join(process.cwd(), 'md', filePath.substring(1));
...
server.listen(PORT, () => {
  ...
  console.log('Serving .md files as HTML with clean URLs');
});